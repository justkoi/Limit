...
public:
	...
	void setMaxElementOfFrame(int frameIdx, DWORD frameTime);
	void addElementOfFrame(int frameIdx, int imageIdx, int frameIntervalX, int frameIntervalY, int imageIntervalX, int imageIntervalY, int w, int h);
